...
const Orders = () => {
  ...
  const showProducts = (id) => {
    fetchDataFromApi(`/api/orders/${id}`).then((res) => {
      // console.log("Order response: ", res.products)
      setIsOpenModal(true);
  ...
  return (
    <>
                      ...
                      ?.map((order, index) => {
                        return (
                          ...
                          <TableCell style={{ minWidth: columns.minWidth }}>
                            ...
                            <TableCell style={{ minWidth: columns.minWidth }}>
                              <MdOutlineDateRange />{" "}
                              {new Date(order?.date).toLocaleDateString('en-GB', { year: 'numeric', month: '2-digit', day: '2-digit' })}
                            </TableCell>
                          </TableRow>
                        );
                      })}
                  ...
                  return (
                    <tr>
                      ...
                      {item?.size ? (
                        ...
                        <Button className="btn-blue" onClick={() => openCustomMeasurementModal(item.customMeasurements)}>
      ...
      <Dialog open={isCustomMeasurementModalOpen} onClose={closeCustomMeasurementModal}>
        <Button className="close_" onClick={closeCustomMeasurementModal}>
          <MdClose />
        </Button>
        ...
        <div className="table-responsive">
          <table className="table table-striped table-bordered">
            ...
            <tbody>
              {customMeasurements &&
                Object.keys(customMeasurements).map((key, index) => (
                  <tr key={index}>
                    <td>{key}</td>
