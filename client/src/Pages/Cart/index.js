...

                    {
                        cartData?.length !== 0 ?
                                                                    ...
                                                                    <Link to={`/product/${item?.productId}`}>
                                                                        <div className="d-flex align-items-center cartItemimgWrapper">
                                                                            ...
                                                                            <div className="info px-3">
                                                                                ...
                                                                                <Rating sx={{color:"#202020"}} name="read-only" value={item?.rating} readOnly size="small" />
                                                                            </div>
                            ...
                            <div className="empty d-flex align-items-center justify-content-center flex-column">
                                <img src={emprtCart} alt="" width="150" />
                                <h3>Your Cart is currently empty</h3>
                                <br />
                                <Link to="/"> <Button className='btn-blue bg-blue btn-lg btn-big btn-round'><FaHome /> &nbsp; Continue Shopping</Button></Link>
                            </div>
